    ...
    playlistComponent(_playlistComponent)
{
    ...
    //playButton.setLookAndFeel(&customButton);
    //loadButton.setLookAndFeel(&customButton);
    //loopButton.setLookAndFeel(&customButton);
    //prevButton.setLookAndFeel(&customButton);
    //nextButton.setLookAndFeel(&customButton);
    //loopStartButton.setLookAndFeel(&customButton);
    //loopEndButton.setLookAndFeel(&customButton);

    //volSlider.setLookAndFeel(&customButton);
    //speedSlider.setLookAndFeel(&customButton);
    ...
    //// color for next and prev buttons
    ...
    //// change colour for load button
    ////loadButton.setColour(juce::TextButton::buttonColourId, juce::Colour::fromString("#FFFFBE48"));
    ////loadButton.setColour(juce::TextButton::textColourOffId, juce::Colours::black);

    //volSlider.addListener(this);

    //// Change volume slider for more surface area to click on 
    ...
    //posSlider.setTextBoxStyle(Slider::TextBoxAbove, true, 0, 0);
    //posSlider.setSliderSnapsToMousePosition(true);

    //// Set range, initial value, and precision to the volume slider
    //volSlider.setRange(0.0, 2.0);
    //volSlider.setValue(0.7);
    //volSlider.setNumDecimalPlacesToDisplay(3);
    //volSlider.setTextBoxStyle(Slider::TextBoxAbove, true, 0, 0);
    ...
    //speedSlider.setTextBoxStyle(Slider::TextBoxAbove, true, 0, 0);
    ...
    ////enable state change and set colour, text colour for each state of the LOOP button
    //loopButton.setClickingTogglesState(true);
    //loopButton.setColour(juce::TextButton::buttonColourId, juce::Colour::fromString("#FF9fc5e8"));
    //loopButton.setColour(juce::TextButton::buttonOnColourId, juce::Colour::fromString("#FFFF5722"));
    ...
    ////enable state change and set colour, text colour for each state of the START LOOP button
    //addAndMakeVisible(loopStartButton);
    //loopStartButton.addListener(this);
    //loopStartButton.setClickingTogglesState(true);
    //loopStartButton.setColour(juce::TextButton::buttonColourId, juce::Colour::fromString("#FF9fc5e8"));
    //loopStartButton.setColour(juce::TextButton::buttonOnColourId, juce::Colour::fromString("#FFFF5722"));
    //loopStartButton.setColour(juce::TextButton::textColourOffId, juce::Colours::black);
    //loopStartButton.setColour(juce::TextButton::textColourOnId, juce::Colours::black);

    ////enable state change and set colour, text colour for each state of the END LOOP button
    //addAndMakeVisible(loopEndButton);
    //loopEndButton.addListener(this);
    //loopEndButton.setClickingTogglesState(true);
    //loopEndButton.setColour(juce::TextButton::buttonColourId, juce::Colour::fromString("#FF9fc5e8"));
    //loopEndButton.setColour(juce::TextButton::buttonOnColourId, juce::Colour::fromString("#FFFF5722"));
    //loopEndButton.setColour(juce::TextButton::textColourOffId, juce::Colours::black);
    //loopEndButton.setColour(juce::TextButton::textColourOnId, juce::Colours::black);
...
void PlaylistLooper::resized()
{
    ...
    //playButton.setBounds(buttonRow.removeFromLeft(buttonW));

    // prev and next buttons
    //prevButton.setBounds(buttonRow.removeFromLeft(buttonW));
    //nextButton.setBounds(buttonRow.removeFromLeft(buttonW));

    // Loop buttons 
    //loopButton.setBounds(buttonRow.removeFromLeft(buttonW));
    //loopStartButton.setBounds(buttonRow.removeFromLeft(buttonW));
    //loopEndButton.setBounds(buttonRow.removeFromLeft(buttonW));
    
    // Load button
    //loadButton.setBounds(buttonRow);
